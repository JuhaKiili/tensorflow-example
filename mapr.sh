...
wget -k "http://$MAPR_HTTPFS/webhdfs/v1/tmp/$MAPR_VOLUME/.snapshot/$MAPR_SNAPSHOT/test-set-labels/t10k-labels-idx1-ubyte.gz?op=open" -O "$VH_INPUTS_DIR/test-set-labels/t10k-labels-idx1-ubyte.gz" --verbose --user $MAPR_USERNAME --password $MAPR_PASSWORD
